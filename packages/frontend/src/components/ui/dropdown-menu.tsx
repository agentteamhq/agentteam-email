    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 z-50
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        data-[state=open]:zoom-in-95 z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin)
