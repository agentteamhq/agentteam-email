...
} from '../../storybook/workspace-mailbox-switcher-fixtures'
import { WorkspaceMailboxSwitcher } from '../../partials/authenticated/workspace-mailbox-switcher'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
import type { WorkspaceMailboxSwitcherProps } from '../../partials/authenticated/workspace-mailbox-switcher'

const meta = {
  title: 'Mail Client/Workspace Switcher/Mocks',
...
export const MailboxList: Story = {
  name: 'mailboxes / list'
}

export const LongMailboxList: Story = {
  name: 'mailboxes / long scrollable list',
  args: {
...
export const WorkspaceSupport: Story = {
  name: 'workspaces / multiple workspaces',
  args: {
    activeWorkspaceId: 'northstar-ops',
    mailboxes: workspaceSwitcherMailboxes,
...
export const EmptyMailboxes: Story = {
  name: 'mailboxes / empty',
  args: {
...
export const LoadingMailboxes: Story = {
  name: 'mailboxes / loading',
  args: {
    activeMailboxId: undefined,
    mailboxes: [],
    state: 'loading'
