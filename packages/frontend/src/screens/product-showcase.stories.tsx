...
import { agentAccessActiveState } from '../storybook/agent-access-fixtures'
import {
  accountSwitchingSidebarView,
  authenticatedSectionBaseArgs
} from '../storybook/authenticated-section-fixtures'
import { mailboxAdminReadyView, mailboxAdminSidebarView } from '../storybook/mailbox-admin-fixtures'
...
const meta = {
  title: 'Product Showcase/Screenshot Assets',
